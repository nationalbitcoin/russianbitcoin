...
static void ApplyStats(CCoinsStats& stats, CHashWriter256D& ss, const uint256& hash, const std::map<uint32_t, Coin>& outputs)
{
...
bool GetUTXOStats(CCoinsView* view, CCoinsStats& stats, CoinStatsHashType hash_type, const std::function<void()>& interruption_point)
{
    ...
    case(CoinStatsHashType::HASH_SERIALIZED): {
        CHashWriter256D ss(SER_GETHASH, PROTOCOL_VERSION);
...
static void PrepareHash(CHashWriter256D& ss, CCoinsStats& stats)
{
    ss << stats.hashBlock;
}
static void PrepareHash(std::nullptr_t, CCoinsStats& stats) {}

static void FinalizeHash(CHashWriter256D& ss, CCoinsStats& stats)
{

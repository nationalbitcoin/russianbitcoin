...
public:
    ...
    virtual SigningResult SignMessage(const std::string& message, const WitnessV0KeyHash& pkhash, std::string& str_sig) const { return SigningResult::SIGNING_FAILED; };
...
public:
    ...
    SigningResult SignMessage(const std::string& message, const WitnessV0KeyHash& pkhash, std::string& str_sig) const override;

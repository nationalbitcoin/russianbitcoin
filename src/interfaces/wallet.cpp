...
public:
    ...
    SigningResult signMessage(const std::string& message, const WitnessV0KeyHash& pkhash, std::string& str_sig) override
    {
    ...
    OutputType getDefaultChangeType() override { return OutputType::BECH32; }

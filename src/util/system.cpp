...
{
    // Windows: C:\Users\Username\AppData\Roaming\russianbitcoin
    // macOS: ~/Library/Application Support/RussianBitcoin
    // Unix-like: ~/.russianbitcoin
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "RussianBitcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // macOS
    return pathRet / "Library/Application Support/RussianBitcoin";
#else
    // Unix-like
